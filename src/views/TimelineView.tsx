...
export function TimelineView({ dataset, onOpenImage, hideContent = false }: { dataset: WorkDataset; onOpenImage: (url: string, title: string) => void; hideContent?: boolean }) {
