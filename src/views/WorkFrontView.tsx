...
export function WorkFrontView({ dataset, onOpenCase, onChange }: { dataset: WorkDataset; onOpenCase: () => void; onChange: (dataset: WorkDataset) => void }) {
