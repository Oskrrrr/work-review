...
export function OverviewView({ dataset, selectedDate, onSelectDate, onOpenImage, onNavigate, hideContent = false }: { dataset: WorkDataset; selectedDate: string; onSelectDate: (date: string) => void; onOpenImage: (url: string, title: string) => void; onNavigate: (view: string) => void; hideContent?: boolean }) {
